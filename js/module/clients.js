...
export const getAllSpanishClientsNames =  async() =>{
    let res = await fetch ("http://localhost:5341/clients?country=Spain")
...
export const getClientsInMadridWithSalesRep11Or30 = async () => {
    let res = await fetch("http://localhost:5341/clients?city=Madrid");
    let data = await res.json();
    let dataUpdate = [];
...
export const getClientsEmploy = async() =>{
    let res = await fetch("http://localhost:5341/clients");
...
export const getOfficesClientsInFuenlabrada = async() => {
    let resClients = await fetch("http://localhost:5341/clients?city=Fuenlabrada");
...
export const getClientByCode = async (code) => {
    let res = await fetch(`http://localhost:5341/clients?client_code=${code}`)
...
export const getClientsOk = async () => {
    let res = await fetch("http://localhost:5341/clients?code_employee_sales_manager");
