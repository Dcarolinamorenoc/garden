    ...
    val.addEventListener("click", (e)=>{
        ...
        if(e.target.innerHTML=="employees"){
            report__details.innerHTML = /*html*/`
                ...
                <my-details logic="employees_4" text="8. Devuelve un listado con el nombre de los empleados junto con el nombre de sus jefes."></my-details>

                <my-details logic="employees_5" text="9. Devuelve un listado que muestre el nombre de cada empleados, el nombre de su jefe y el nombre del jefe de sus jefe."></my-details>

                <my-details logic="employees_6" text="4. Devuelve un listado que muestre solamente los empleados que no tienen una oficina asociada."></my-details>

                <my-details logic="employees_7" text="5. Devuelve un listado que muestre solamente los empleados que no tienen un cliente asociado."></my-details>
                ...
                <my-details logic="employees_10" text="12. Devuelve un listado con los datos de los empleados que no tienen clientes asociados y el nombre de su jefe asociado."></my-details>
        ...
        if(e.target.innerHTML=="clients"){
            report__details.innerHTML = /*html*/`
                ...
                <my-details logic="client_13" text=" 11. Devuelve un listado con los clientes que han realizado algún pedido pero no han realizado ningún pago."></my-details>
